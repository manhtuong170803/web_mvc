                ...
                ?>     
					...
					<tbody>
						...
						<tr class="odd gradeX">
                            ...
                            ?></td>
							<td><a href="postedit.php?catid=<?php echo $result['id_cate_post'] ?>">Edit</a> || <a onclick="return confirm('Are you want to delete?')" 
							       href="?delid=<?php echo $result['id_cate_post'] ?>">Delete</a></td>
						</tr>
						    <?php
						}
							}
